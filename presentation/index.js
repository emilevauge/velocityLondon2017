    ...
    return (
      <Deck transition={["slide"]} transitionDuration={300} theme={theme}>
        ...
        <Slide bgColor="white">
          ...
          <Text margin="40" >Emile Vauge — Velocity London 2017</Text>
        </Slide>
        ...
        <Slide >
          ...
          <Text >
            <Link href="https://emilevauge.github.io/velocityLondon2017">emilevauge.github.io/velocityLondon2017</Link>
          </Text>
        </Slide>
      </Deck>
    );
